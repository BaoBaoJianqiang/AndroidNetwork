...
public class RemoteService {
    ...
    public void invoke(final String apiKey,
        ...
        if (urlData.getNetType().equals(REQUEST_GET)) {
            ...
            //get使用缓存
            if (urlData.getExpires() > 0 && !forceUpdate) {
